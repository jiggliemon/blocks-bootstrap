...
_.extend(Obj.prototype, Parse.Events,
         /** @lends Obj.prototype */ {
  _existed: false,
  ...
  _resetCacheForKey: function (key) {
    ...
    if (_.isObj(value) && !(value instanceof Obj)) {
  ...
  set: function (key, value, options) {
    var attrs, attr;
    if (_.isObj(key) || core._isNullOrUndefined(key)) {
      attrs = key;
  ...
  save: function (arg1, arg2, arg3) {
    ...
    if (_.isObj(arg1) || core._isNullOrUndefined(arg1)) {
      attrs = arg1;
      options = arg2;
    } else {
      attrs = {};
    ...
    newOptions.error = Obj._wrapError(newOptions.error, model,
                                               newOptions);
  ...
  destroy: function (options) {
    ...
    core._request("classes", this.className, this.id, 'DELETE', null,
                  options);
    if (!options.wait) {
      triggerDestroy();
    }
  ...
  validate: function (attrs, options) {
    if (_.has(attrs, "ACL") && !(attrs.ACL instanceof ACL)) {
      return new Error(Error.OTHER_CAUSE,
