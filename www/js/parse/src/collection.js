 ...
 * <code>Collection.extend</code>.
 *
 * @param {Array} models An array of instances of <code>Obj</code>.
 *
 * @param {Object} options An optional object with Backbone-style options.
 * Valid options are:<ul>
 *   <li>model: The Obj subclass that this collection contains.
...
_.extend(Collection.prototype, Parse.Events,
    /** @lends Collection.prototype */ {

  // The default model for a collection is just a Obj.
  ...
  fetch: function(options) {
    ...
    options.error = Obj._wrapError(options.error, collection,
                                            options);
  ...
  _onModelEvent: function(ev, model, collection, options) {
    var self = this
    if ((ev === 'add' || ev === 'remove') && collection !== self) {
      return;
    }
    if (ev === 'destroy') {
    ...
    if (model && ev === 'change:objectId') {
      delete self._byId[model.previous("objectId")];
...
/**
 * Creates a new subclass of <code>Collection</code>.  For example,<pre>
 ...
 * @return {Class} A new subclass of <code>Collection</code>.
 */
Collection.extend = core._extend;
